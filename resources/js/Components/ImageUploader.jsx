...
const ImageUploader = ({ show, handleClose, onCompleted, optionGroupIndex, optionIndex,closeOnComplete }) => {
        ...
        if (files.length > 0) {
            ...
            axios.post(
                ...
                .then((res) => {
                    ...
                    onCompleted(res.data.imageUrl, optionGroupIndex, optionIndex)
