                                                            ...
                                                            <div>
                                                                {
                                                                    pollGroup.options.map((voteOption, voteOptionIndex) => (
                                                                        <div className="card bg-secondary bg-opacity-10" key={index}>
                                                                                    ...
                                                                                    <p className='mb-1 text-white-50 fw-light'><small>Users who voted this option:</small></p>
                                                                                    {
                                                                                        voteOption.votes.map((vote, voteIndex) => (
                                                                                            <div className="col-lg-auto col-auto" key={voteIndex}>
                                                                                                ...
                                                                                                <OverlayTrigger trigger="hover" placement="top" overlay={voterInfoPopover(vote.voter)}>
                                                                                                    <div>
                                                                                                        {
                                                                                                            vote.voter.photo ? (
                                                                                                                <ProfilePhoto className="border border-3 border-dark-purple shadow-sm" image={vote.voter.photo} size='sm' />
                                                                                                            ) : (
                                                                                                                <TextProfilePic bg='secondary' classname="sm border shadow-sm" fluid text={vote.voter.firstname[0] + vote.voter.lastname[0]} />
                                                                                                            )
                                                                                                        }
                                                                                                    </div>
                                                                                                </OverlayTrigger>
